...
export default function EditProfileForm({ action, userData }) {
	...
	return (
		<form
			...
			className="space-y-12 border-b border-gray-900/20 px-0 pb-12 sm:px-44 dark:border-gray-400/50"
		>
			<div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
				...
				<div className="col-span-full">
					...
					<p className="text-end text-sm/6 text-gray-600 dark:text-gray-400/80">
						{bio.length}/120 characters used
					</p>
				</div>
				...
				<div className="col-span-full">
					...
					<input
						...
						className="mt-2 block w-full cursor-pointer rounded-md bg-slate-100 px-3 py-1.5 text-base text-violet-950 outline-1 -outline-offset-1 outline-gray-300 file:mr-4 file:rounded-md file:border-0 file:bg-violet-500 file:px-4 file:py-1.5 file:font-semibold file:text-violet-100 hover:file:bg-violet-700 sm:text-sm/6 dark:bg-slate-500 dark:text-violet-100 dark:file:bg-violet-700 dark:hover:file:bg-violet-600"
					/>
					<Image
						src={croppedImage || userData.imageUrl}
						alt="Profile Image"
						width={300}
						height={300}
						className="mt-6 h-32 w-32 rounded-full"
					/>
				</div>
