    ...
    return (
        <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <p className="mt-5 text-center text-lg/9 tracking-tight text-gray-500 dark:text-gray-100">Input the ISBN to autofill fields!</p>
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <NewBookForm action={AddBook} userData={JSON.parse(JSON.stringify(userData))} />
            </div>
        </div>
    );
}